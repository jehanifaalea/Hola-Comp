...
def rekomendasi_laptop():
    ...
    if tampilkan_spesifikasi.lower() == "ya":
        ...
        if tampilkan_prosesor.lower() == "ya":
            ...
            laptop_rekomendasi = [laptop for laptop in laptop_rekomendasi if laptop_rekomendasi[laptop]['prosesor'] == prosesor]
        ...
        if tampilkan_ram.lower() == "ya":
            ...
            laptop_rekomendasi = [laptop for laptop in laptop_rekomendasi if laptop_rekomendasi[laptop]['ram'] == ram]
        ...
        if tampilkan_rom.lower() == "ya":
            ...
            laptop_rekomendasi = [laptop for laptop in laptop_rekomendasi if laptop_rekomendasi[laptop]['rom'] == rom]
        
        print("Laptop rekomendasi berdasarkan spesifikasi:")
        for laptop in laptop_rekomendasi:
            print("- Merk:", laptop_rekomendasi[laptop]['merk'])
            print("- Prosesor:", laptop_rekomendasi[laptop]['prosesor'])
            print("- RAM:", laptop_rekomendasi[laptop]['ram'], "GB")
            print("- ROM:",laptop_rekomendasi[laptop]['rom'], "GB")
            print("- Harga:", laptop_rekomendasi[laptop]['harga'])
    else:
